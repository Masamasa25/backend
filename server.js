...
const sequelize = new Sequelize('masaasr5_visum@localhost', 'masaasr5_visum@localhost', '253410Lmr', {
  host: 'localhost',
  port: '3306',
  dialect: 'mysql',
});
...
router.post('/room-members', createRoomMember);
router.post('/get-url', getVideoUrl);
router.post('/messages', createMessage);
router.post('/room-messages', createRoomMessage);
router.get('/rooms/:roomId/messages', getAllRoomMessages);
router.get('/rooms/:roomId/users', getUsersInRoom);
